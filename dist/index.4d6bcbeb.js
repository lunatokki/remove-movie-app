...
class TheHeader extends (0, _heropy.Component) {
    ...
    render() {
      ...
      <a
       href="#/" 
       class="logo"><span>OMDbAPI</span>.COM
      </a>
      <nav>
        <ul>
          ${this.state.menus.map((menu)=>{
            const href = menu.href.split("?")[0];
            const hash = lacation.hash.split("?")[0];
...
class TheFooter extends (0, _heropy.Component) {
    ...
    render() {
        const { github, repository } = (0, _aboutDefault.default).state.this.el.innerHTML = /* html */ `
      <div>
        <a href="${repository}">
          GitHub Repository
        </a>
...
},{"../core/heropy":"57bZf","./Home":"0JSNG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Movie":"1LTyN","./About":"gdB30","./NotFound.js":"4fDiL"}],"0JSNG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _heropy = require("../core/heropy");
...
const getMovieDetails = async (id)=>{
    try {
        ...
        console.group("getMovieDetails error:", error);
    }
};
...
class MovieItem extends (0, _heropy.Component) {
    ...
    render() {
        ...
        this.el.setAttribute("href", `#/mokvie?id=${movie.imdbID}`);
